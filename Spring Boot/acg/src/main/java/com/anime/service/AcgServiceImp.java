...
public class AcgServiceImp implements AcgService {
     ...
     */
    @Override
    public List<AcgModel> searchAllField(AcgQueryModel query) throws Exception{
     ...
     */
    @Override
    public List<AcgModel> searchCriticalField(AcgQueryModel query) throws Exception{
        if (query.getPageInfo()==null || query.getPageInfo().getPageSize() == 0) {
            PageInfo pageInfo = new PageInfo();
            query.setPageInfo(pageInfo);
        }
     ...
     */
    @Override
    public List<AcgModel> searchAdvanced(AcgQueryModel query) throws Exception{
        if (query.getPageInfo()==null || query.getPageInfo().getPageSize() == 0) {
            PageInfo pageInfo = new PageInfo();
            query.setPageInfo(pageInfo);
        }
     ...
     */
    @Override
    public long getCount(AcgQueryModel query) throws Exception {
